...
<html>
	...
	<body style="overflow: auto;">
		<div class="topo">
			<div class="topo-menu">
				<a class="btn" style="color: #fff; font-size: 20px; background-color: rgba(0,51,101, 1)" href="index.php" role="button">Voltar</a>
			</div>
		...
		<div>
			<form class="formCadastrar col-11 col-sm-11 col-md-11 col-lg-9 col-xl-7" action="_insert_usuario_externo.php" method="post">
